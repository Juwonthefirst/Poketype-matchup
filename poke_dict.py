poke_dict = {
    ...
    "Burmy": ["Bug"],
    "Wormadam":{"Plant cloak": ["Bug", "Grass"],"Trash cloak": ["Bug", "Steel"],"Sandy cloak": ["Bug", "Ground"]},
    "Mothim": ["Bug", "Flying"],
    "Combee": ["Bug", "Flying"],
    ...
    "Darumaka": ["Fire"],
    "Darmanitan":{"Zen Mode": ["Fire", "Psychic"],"Standard Mode": ["Fire"]},
    "Maractus": ["Grass"],
    "Dwebble": ["Bug", "Rock"],
    "Crustle": ["Bug", "Rock"],
    ...
    "Diancie": ["Rock", "Fairy"],
    "Hoopa":{"Confined" :["Psychic", "Ghost"],"Unbound":["Psychic","Dark"]},
